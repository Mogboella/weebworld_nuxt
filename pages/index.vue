  ...
  <div class="home_content">
      ...
      <v-container>
          <div class="home_content_scroll">
            <nuxt-link to="/about" class="default_link">
              <img src="svg/scroll.svg" alt="Here ALt">
          ...
          <v-layout row class="row_home_wrapper">
              ...
              <v-flex x6 class="home_content_right">
                  <div class="home_content_nav">
                      ...
                      <nuxt-link to="/library" class="default_link"><span>Library</span> </nuxt-link> 
                        <nuxt-link to="/discover" class="default_link"> <span>Discover</span> </nuxt-link> 
                  </div>
